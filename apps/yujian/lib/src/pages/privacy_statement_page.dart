    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          h('一句话'),
          p('账本在你的手机上。余见没有任何自己的服务器接收你的数据，也没有统计、埋点、广告 SDK。唯一会把数据发出手机的，是你自己填进去的大模型 / 语音服务——发之前默认打码，每一次都写进「出网记录」。打开「纯本地模式」，连这条路也掐掉。'),
          ...
          row('版本检查', '只有请求本身：服务器能看到你的 IP 和 App 版本号，不带任何账本数据', 'yujian.ivyea.com（余见唯一的自家域名，只做版本检查和离线模型包分发）', '每天最多一次；纯本地模式下只有你手动点「检查更新」', '开「纯本地模式」'),
